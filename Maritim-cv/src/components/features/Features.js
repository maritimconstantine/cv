    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6 xl:gap-20">
        <Card
          ...
          des="Our developers build scalable, secure, and performance-optimized websites 
        ...
        <Card
          ...
          des=" We perform thorough functional, performance, security, and usability testing 
        ...
        <Card
          ...
          des="Before long-term support, we fine-tune your platform for speed, stability,
        ...
        <Card
          ...
          des="After launch, we provide ongoing maintenance, performance monitoring, security updates,
